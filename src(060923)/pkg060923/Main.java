...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        arrayPerson[0] = new persona("Fernando", "Mulato", "104623013232235");
        arrayPerson[1] = new persona("Juan", "Lopez", "1233437373783289");
        arrayPerson[2] = new persona("Monica", "Ramirez", "1066656433235");
